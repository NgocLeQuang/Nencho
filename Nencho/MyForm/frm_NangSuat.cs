...
namespace Nencho.MyForm
{
    public partial class frm_NangSuat : XtraForm
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if(xtraTabControl1.SelectedTabPage==tp_DeJP)
            {
                dataGridView1.DataSource = Global.DataNencho.NangSuatCheck2(_firstDateTime, _lastDateTime);
                if (!File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Productivity_Checker2.xls"))
                {
                    File.Delete(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Productivity_Checker2.xls");
                    File.WriteAllBytes((Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Productivity_Checker2.xls"), Resources.Productivity_Checker2);
                }
                else
                {
                    File.WriteAllBytes((Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Productivity_Checker2.xls"), Resources.Productivity_Checker2);
            ...
            else if(xtraTabControl1.SelectedTabPage==tp_DeSo)
            {
                ...
                {
                    File.Delete(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Productivity_Checker1.xls");
